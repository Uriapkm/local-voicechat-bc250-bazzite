...
# Verificar que config.ini existe o crearlo (usando ruta relativa al script)
...
# Usa rutas relativas: SCRIPT_DIR se resuelve automáticamente al directorio del script
...
if [ "$CONTAINER_EXISTS" = "false" ]; then
    ...
    # Instalar requirements.txt (usando ruta relativa al script)
